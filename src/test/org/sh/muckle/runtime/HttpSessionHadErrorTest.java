...
public class HttpSessionHadErrorTest extends TestCase implements IHttpSessionStatusVisitor {

	RuntimeException ex;
	HttpSessionHadError hadErr;
	
	public void testVisit(){
		assertNotNull(hadErr.accept(this));
	}
	
	public void testGetThrowable(){
		assertTrue(ex == hadErr.getThrowable());
	}
	
	public void setUp() throws Exception {
		super.setUp();
		ex = new RuntimeException();
		hadErr = new HttpSessionHadError(ex);
	}
